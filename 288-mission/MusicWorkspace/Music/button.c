...
uint8_t button_getButton() {
	...
	// INSERT CODE HERE!
    if(((GPIO_PORTE_DATA_R & 1) == 0) && (((GPIO_PORTE_DATA_R >> 1) & 1) == 1) && (((GPIO_PORTE_DATA_R >> 2) & 1) == 1) && (((GPIO_PORTE_DATA_R >> 3) & 1) == 1)) {
        return 1;
    }

    if((((GPIO_PORTE_DATA_R >> 1) & 1) == 0) && (((GPIO_PORTE_DATA_R >> 2) & 1) == 1) && (((GPIO_PORTE_DATA_R >> 3) & 1) == 1)) {
        return 2;
    }
